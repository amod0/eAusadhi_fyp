...
const PaymentScreen = () => {
  ...
  let totalPriceInPaisa = cart.totalPrice * 100;
  const { shippingAddress } = cart;
  ...
  const handleKhaltiPayment = async () => {
    const payload = {
      "return_url": `http://localhost:3000/placeorder`,
      "website_url": 'http://localhost:3000/',
      amount: totalPriceInPaisa, //Add dynamic price here
      "purchase_order_id": `E-Aausadi`,
      "purchase_order_name": `E-Aausadi`,
      "merchant_username":'E-Aausadi',
      "customer_info": {
  ...
  return (
    <FormContainer>
      ...
      <Form onSubmit={submitHandler}>
        ...
        {/* <Button type='submit' variant='primary' onClick={() => checkout.show({amount: totalPriceInPaisa})}> */}
        <Button variant='primary' onClick={handleKhaltiPayment}>
